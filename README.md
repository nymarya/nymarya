...
<!-- logos ends -->
    ...
    <tr>
        <!-- pcts starts -->
 <td> <sub>Jupyter Notebook: <br>72.72%</sub> </td>
<td> <sub>C++: <br>11.99%</sub> </td>
<td> <sub>HTML: <br>5.34%</sub> </td>
<td> <sub>C: <br>4.93%</sub> </td>
<td> <sub>Java: <br>1.78%</sub> </td>
<td> <sub>Python: <br>1.70%</sub> </td>
